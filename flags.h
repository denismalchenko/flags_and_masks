...
#define MASK_BIT4(n1, n2, n3, n4) ((1ULL<<n1) | (1ULL<<n2) | (1ULL<<n3) | (1ULL<<n4))
#define MASK_BIT5(n1, n2, n3, n4, n5) ((1ULL<<n1) | (1ULL<<n2) | (1ULL<<n3) | (1ULL<<n4) | (1ULL<<n5))
...
#define MERGE_MASK5(mask1, mask2, mask3, mask4, mask5) (mask1 | mask2 | mask3 | mask4 | mask5)
...
#define CROSS_MASK5(mask1, mask2, mask3, mask4, mask5) (mask1 & mask2 & mask3 & mask4 & mask5)
...
//  creating a mask
#define MASK_FROM_BITS(...) GET_MACRO(__VA_ARGS__, MASK_BIT5, MASK_BIT4, MASK_BIT3, MASK_BIT2, MASK_BIT1)(__VA_ARGS__)
#define MERGE_MASKS(...) GET_MACRO(__VA_ARGS__, MERGE_MASK5, MERGE_MASK4, MERGE_MASK3, MERGE_MASK2, MERGE_MASK1)(__VA_ARGS__)
#define CROSS_MASKS(...) GET_MACRO(__VA_ARGS__, CROSS_MASK5, CROSS_MASK4, CROSS_MASK3, CROSS_MASK2, CROSS_MASK1)(__VA_ARGS__)
#define INVERSE_FLAGS(flags) (~flags)
